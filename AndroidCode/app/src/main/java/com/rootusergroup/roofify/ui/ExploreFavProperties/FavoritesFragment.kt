...
class FavoritesFragment : Fragment(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreateView(
        ...
        binding.myPropertyCardImage3.setOnClickListener {
            findNavController().navigate(R.id.fragment_detailedHouse)
        }
